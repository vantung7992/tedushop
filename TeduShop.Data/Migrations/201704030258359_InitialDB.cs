    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ProducCategories", t => t.CategoryID, cascadeDelete: true)
                .Index(t => t.CategoryID);
            
            CreateTable(
                "dbo.ProducCategories",
                c => new
                    {
                        ID = c.Int(nullable: false, identity: true),
                        Name = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "CategoryID", "dbo.PostCategeries");
            DropForeignKey("dbo.OrderDetails", "ProductID", "dbo.Products");
            DropForeignKey("dbo.Products", "CategoryID", "dbo.ProducCategories");
            ...
            DropTable("dbo.VisotorStatistics");
            ...
            DropTable("dbo.Posts");
            DropTable("dbo.PostCategeries");
            DropTable("dbo.Pages");
            DropTable("dbo.ProducCategories");
